...
for tme in times:
	...
	np.savetxt('6-abEerrOfAllModels_Linear_' + tme + '.csv', matrixABE, delimiter=",")
	np.savetxt('6-abEerrOfAllModels_Linear-NoNaN_' + tme + '.csv', matrixABE[np.logical_not(np.isnan(matrixABE))], delimiter=",")
