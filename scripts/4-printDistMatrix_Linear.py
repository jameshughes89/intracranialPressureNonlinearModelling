...
for tme in times:
	iFile =  csv.reader(open('3-abEmat_Linear_' + tme + '.csv', 'r'))
	...
	iFile =  csv.reader(open('3-msEmat_Linear_' + tme + '.csv', 'r'))
	mseMat = []
	for l in iFile:
		mseMat.append(l)
	...
	iFile =  csv.reader(open('3-corrmat_Linear_' + tme + '.csv', 'r'))
	corrMat = []
	for l in iFile:
		corrMat.append(l)
