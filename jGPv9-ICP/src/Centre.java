...
public class Centre 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		SEED = 1;
		NUMBER_RUNS = NUMBER_RUNS = Integer.parseInt(args[2]);
		...
		GENERATIONS = 10100;//2500			//25000 works well		
		...
		///////////////////////////////
		PREDICTOR_SIZE = 0.2;		//rate based on theData size (NORMALLY 0.1, FOR COMBINATION, 0.01!!)
		//
		//PREDICTOR_GENS = 0.05;      //rate based on GENERATIONS (NOT GENES)
		
		SEGMENT = Integer.parseInt(args[3]);
		...
		//TEST AREA
		int sValue = Integer.parseInt(args[1]);
